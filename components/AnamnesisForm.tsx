    ...
    <div className="max-w-4xl mx-auto">
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
            ...
            {isSaved && (
                <span className="text-emerald-600 font-medium text-sm flex items-center gap-1 bg-emerald-50 px-3 py-1 rounded-full">
        ...
        <div className="p-6 md:p-8 space-y-8">
            ...
            <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Queixa Principal / Objetivo Específico</label>
                <textarea 
                    name="mainComplaint"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <h4 className="font-bold text-slate-400 text-xs uppercase tracking-wider border-b border-slate-100 pb-2 flex items-center gap-2">
                        <AlertCircle size={14} /> Histórico de Saúde
                    </h4>
                    
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Patologias / Histórico Familiar</label>
                        <textarea 
                            name="history"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Alergias / Intolerâncias</label>
                        <input 
                            type="text"
                            name="allergies"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Medicamentos / Suplementos em uso</label>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">Intestino</label>
                            <select 
                                name="bowelFunction"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Consumo de Álcool</label>
                        <input 
                            type="text"
                            name="alcohol"
